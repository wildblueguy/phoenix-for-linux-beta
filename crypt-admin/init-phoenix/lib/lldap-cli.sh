...
# Adapted from https://github.com/Zepmann/lldap-cli/blob/56b9faf400ae67269b8fbbd575d86b67d2395de5/lldap-cli for LLDAP v0.6.1

# Config for running from container
lldapConfig="/data/lldap_config.toml"
username="ldap-admin"
...
setUserPassword() {
  ...
  /app/lldap_set_password -b "$httpUrl" --token="$httpToken" -u "$userId" -p "$newPassword" # Adapted
}
